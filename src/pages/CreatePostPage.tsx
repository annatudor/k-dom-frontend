...
export default function CreatePostPage() {
  ...
  // Handler for tag changes - now properly used
  const handleTagsChange = (tags: KDomTagSearchResultDto[]) => {
    setSelectedTags(tags);
    console.log("Tags updated:", tags); // For debugging
  };
  ...
  const handleSubmit = async () => {
    ...
    console.log("Submitting post data:", postData); // For debugging
            ...
            <VStack spacing={6} align="stretch">
              ...
              <FormControl>
                ...
                <KDomTagSelector
                  ...
                  onTagsChange={handleTagsChange} // Now properly using the function
                  maxTags={5}
                />
